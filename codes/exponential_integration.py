...
def phi1(A):
    ...
    # Pade' coefficients
    n = np.array([1.0, 1.0 / 30, 1.0 / 30, 1.0 / 936, 1.0 / 4680, 1.0 / 171600, 1.0 / 3603600, 1.0 / 259459200])
    d = np.array([1.0, - 7.0 / 15,  1.0 / 10, - 1.0 / 78, 1.0 / 936, -1/17160, 1/514800, - 1.0 / 32432400])
    q = np.size(n)
    N = n[0] * ID
    D = d[0] * ID
    X = ID.copy()
